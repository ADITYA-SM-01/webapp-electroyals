...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-gray-900 to-black">
      ...
      <div className="absolute top-0 left-0 w-1/2 h-full bg-gradient-to-r from-black/60 to-transparent pointer-events-none z-5"></div>

      {/* Full-screen 3D model container - Set behind content but with necessary pointer events */}
      <div ref={modelContainerRef} className="absolute inset-0 z-10 pointer-events-auto">
        {/* The 3D model */}
        <div ref={modelRef} className="w-full h-full pointer-events-auto">
          <ModelViewer 
      ...
      {/* Transparent overlay to capture button clicks but let model dragging through */}
      <div className="absolute inset-0 z-20" style={{ pointerEvents: 'none' }}>
        {/* Main content container - Selective pointer-events */}
        <div className="container relative mx-auto px-4 sm:px-6 lg:px-8 py-0 min-h-screen">
          <div className="flex items-center min-h-[80vh] pt-20 md:pt-24">
            {/* Text Content with proper spacing from top */}
            <div className="w-full lg:w-2/3 select-none mt-16 relative">
              <motion.div 
