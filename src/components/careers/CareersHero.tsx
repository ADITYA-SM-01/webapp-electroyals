      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 dark:text-white mb-6">
            Join Our <span className="bg-clip-text text-transparent bg-gradient-to-r from-electroyals-500 to-electroyals-600">Team</span>
          </h1>
          <p className="mt-6 text-lg sm:text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
            Take your career to the next level by joining our talented team of professionals.
