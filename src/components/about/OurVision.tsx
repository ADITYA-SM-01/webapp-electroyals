...
const OurVision = () => {
  return (
    <section className="py-16 relative bg-gradient-to-b from-gray-900/90 to-black text-white overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div 
          ...
          className="absolute -top-20 -right-20 w-60 h-60 bg-blue-700/30 rounded-full blur-3xl"
        />
        <motion.div 
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.2 }}
          transition={{ duration: 4, ease: "easeInOut", repeat: Infinity, repeatType: "reverse", delay: 1 }}
          className="absolute bottom-0 left-0 w-80 h-80 bg-indigo-700/20 rounded-full blur-3xl"
        />
      </div>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <SimpleAnimation variants={slideLeft} className="md:w-1/2" delay={0.2}>
            ...
            border border-blue-700/50 h-full">
              ...
              <div className="absolute -top-8 -right-8 w-40 h-40 bg-gradient-conic from-blue-600/30 via-indigo-600/15 to-transparent rounded-full blur-xl animate-slow-spin"></div>
              
              <div className="flex items-center mb-6">
                <motion.div 
                  whileHover={{ rotate: 360, scale: 1.1 }}
                  transition={{ duration: 0.8, ease: "easeInOut" }}
                  className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-800/40 to-indigo-800/40 flex items-center justify-center 
                  shadow-inner shadow-blue-700/30 z-10 relative mr-4"
                >
                  <Rocket className="h-8 w-8 text-blue-500" />
                </motion.div>
                <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-indigo-400">Our Vision</h3>
              </div>
              ...
              >
                {["Pioneering technological advancements", "Setting new industry standards", "Creating sustainable technological ecosystems"].map((item, index) => (
                  ...
                  >
                    ...
                    >
                      <ArrowRight className="h-5 w-5 text-blue-500 mt-1 mr-2 flex-shrink-0" />
                    </motion.div>
          ...
          <SimpleAnimation variants={slideRight} className="md:w-1/2" delay={0.3}>
            ...
            border border-indigo-700/50 h-full">
              ...
              <motion.div 
                ...
                className="absolute -top-8 -left-8 w-40 h-40 bg-gradient-radial from-indigo-600/30 to-transparent rounded-full blur-xl"
              ></motion.div>
              ...
              <div className="flex items-center mb-6">
                <motion.div 
                  whileHover={{ rotate: 360, scale: 1.1 }}
                  transition={{ duration: 0.8, ease: "easeInOut" }}
                  className="w-14 h-14 rounded-full bg-gradient-to-br from-indigo-800/40 to-purple-800/40 flex items-center justify-center 
                  shadow-inner shadow-indigo-700/30 z-10 relative mr-4"
                >
                  <Lightbulb className="h-8 w-8 text-indigo-500" />
                </motion.div>
                <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-purple-400">Our Mission</h3>
              </div>
                ...
                {["Delivering transformative solutions", "Building lasting client relationships", "Maintaining the highest standards of excellence"].map((item, index) => (
                  ...
                  >
                    <motion.div
                      ...
                      transition={{ duration: 0.3 }}
                    >
                      <ArrowRight className="h-5 w-5 text-indigo-500 mt-1 mr-2 flex-shrink-0" />
                    </motion.div>
                    <span className="text-gray-300">{item}</span>
                  </motion.li>
                ))}
