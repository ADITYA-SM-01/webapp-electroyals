...
const values = [
  {
    icon: <Heart className="h-8 w-8 sm:h-10 sm:w-10 text-red-500" />,
  ...
  {
    icon: <Target className="h-8 w-8 sm:h-10 sm:w-10 text-blue-500" />,
  ...
  {
    icon: <Sparkles className="h-8 w-8 sm:h-10 sm:w-10 text-purple-500" />,
...
const OurValues = () => {
  return (
    <section className="py-12 sm:py-16 bg-gradient-to-b from-electroyals-navy/80 to-gray-900/90 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <motion.div 
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[25rem] sm:w-[40rem] h-[25rem] sm:h-[40rem]"
          style={{
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <SimpleAnimation>
          <div className="max-w-3xl mx-auto text-center mb-10 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-300 to-indigo-400">
        ...
        <SimpleStagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {values.map((value, index) => (
            <SimpleAnimation 
              key={index}
              delay={index * 0.1}
              className="bg-gradient-to-br from-gray-900/90 to-gray-800/90 
              backdrop-blur-sm rounded-xl p-5 sm:p-8 text-center shadow-md hover:shadow-xl 
              hover:shadow-blue-500/20 
              transition-all duration-300 hover:-translate-y-1 relative overflow-hidden 
              border border-indigo-500/20"
            >
              {/* Star glow behind the icon */}
              <div className="absolute top-6 sm:top-8 left-1/2 -translate-x-1/2 w-16 sm:w-20 h-16 sm:h-20 rounded-full" 
                style={{
              ...
              <motion.div 
                ...
                className="w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-4 sm:mb-6 rounded-full bg-gray-800/80 flex items-center justify-center 
              ...
              <motion.div 
                ...
                className="absolute -top-6 -right-6 w-16 sm:w-20 h-16 sm:h-20 border border-indigo-500/10 rounded-full"
